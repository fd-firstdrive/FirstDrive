...
private:
	...
	vector <LAPAREA> lapsequence, stop, ceda, park;
...
public:
	...
	void AddStopSequence(BEZIER * patch);
	void AddCedaSequence(BEZIER * patch);
	void AddParkSequence(BEZIER * patch);
