Configuring the display is done by editing [FirstDrive.config](FirstDrive_config.md) manually, or by changing the settings in the Options -&gt; Display and Options -&gt; Display -&gt; Advanced menus.
