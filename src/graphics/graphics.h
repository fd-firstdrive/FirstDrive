...
public:
	...
	//virtual void UpdateSceneRVM(float /*dt*/) {};

	virtual void DrawScene(std::ostream & error_output) = 0;
	virtual void DrawScene(std::ostream & error_output, int offset_w, int offset_h, int w2, int h2) = 0;
	//virtual void DrawSceneRVM(std::ostream & error_output) = 0;
