...
public:
	...
	//void render(GLWrapper & gl, unsigned int ow, unsigned int oh, unsigned int w, unsigned int h, StringIdMap & stringMap, const std::vector <const std::vector <RenderModelExt*>*> & externalModels, const NameTexMap & sharedTextures, std::ostream & errorOutput);
