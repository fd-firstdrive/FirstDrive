...
public:
	...
	//void render(unsigned int ow, unsigned int oh, unsigned int w, unsigned int h, StringIdMap & stringMap, const std::map <StringId, std::vector <RenderModelExt*> > & externalModels, std::ostream & errorOutput);
	...
	/// ow and oh are the origin point for the width and height of the application's window.
	void render(unsigned int ow, unsigned int oh, unsigned int w, unsigned int h, StringIdMap & stringMap, const std::map <StringId, std::map <StringId, std::vector <RenderModelExt*> *> > & externalModels, std::ostream & errorOutput);
