...
std::vector<std::string> CarControlMap::InitCarInputStrings()
{
	...
	//NEW CONTROLS: indicator lights
	
	strings[CarInput::INDICATOR_LEFT]  = "indicator_left";
	strings[CarInput::INDICATOR_RIGHT] = "indicator_right";
	strings[CarInput::EMERGENCY]       = "emergency_lights";
	strings[CarInput::LIGHTS]          = "toggle_lights";
